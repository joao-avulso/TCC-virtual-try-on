...
export class ProvadorViewport {
    ...
    constructor(containerId) {
        ...
        camera.position.z = 3; camera.position.y = 1;


        // Iluminação da cena
        const ambientLight = new THREE.AmbientLight(0xffffff, 3.5);
        const pointLight = new THREE.PointLight(0xffffff, 50); pointLight.position.set(2, 2, 2);
        const pointLight2 = new THREE.PointLight(0x4287f5, 100); pointLight2.position.set(-4, 0, -2);
        const pointLight3 = new THREE.PointLight(0xffffff, 150); pointLight3.position.set(4, 3, -2);
        const pointLight4 = new THREE.PointLight(0xffffff, 20); pointLight4.position.set(-2, 2, 2);
